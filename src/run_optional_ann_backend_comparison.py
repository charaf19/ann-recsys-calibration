...
Output: results/analyses/optional_backends/optional_ann_backend_comparison.csv
...
def main():
    ...
    write_dataframe_atomic(
        df, csv_path, mode=args.write_mode,
        key=["backend", "vectors_source", "n_items", "dim", "seed"],
        sort_by=["backend"])
